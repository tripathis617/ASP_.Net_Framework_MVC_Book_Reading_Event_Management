...
namespace BookReadingEventManagement.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalInviteByEmails = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookReadingEvents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_BookReadingEvents_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersEvents_BookReadingEvents_EventId",
                        column: x => x.EventId,
                        principalTable: "BookReadingEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade,
